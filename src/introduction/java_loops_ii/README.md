...
We use the integers ___a___, ___b___ and ___n___. For each query, print the series corresponding to the given ___a___, ___b___ and ___n___ values as a single line of ___n___ space-separated integers.
